...
namespace Conversive.DevBot5
{
	...
	public class CSharpToolbox
	{
        ...
        private string STD_MODULE_NAME = "DevBotStandard";
		...
		public void AssembleCode()
		{
			...
			assemblyCode += "using Conversive.DevBot5;\r\n";
		...
		public bool Compile()//true if successful
		{
			...
			//parameters.ReferencedAssemblies.Add(Application.StartupPath + Path.DirectorySeparatorChar + "DevBot5Library.dll");
			//use this instead
