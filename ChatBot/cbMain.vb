...
Imports System.Data
Imports Conversive.DevBot5

Imports System.IO

Public Class cbMain
    Inherits System.Windows.Forms.Form
    Private DevBot As DevBot5Engine
    Private state As State
    Private stCKBFileFilter As String = "DevBot Knowledge Bases (*.vkb)|*.vkb"
    Private stFormName As String = "DevBot SDK Windows App Sample"
    ...
    Private Sub getReply()
        ...
        Dim reply As Reply = Me.DevBot.GetReply(stInput, Me.state)
